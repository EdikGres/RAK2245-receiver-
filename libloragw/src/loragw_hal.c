...
void lgw_constant_adjust(void) {
   ...
   // lgw_reg_w(LGW_PREAMBLE_SYMB1_NB,8); /* default 10 */
    ...
    // lgw_reg_w(LGW_MBWSSF_SYNCH_DETECT_TH,0); /* default 1 */
    ...
    // lgw_reg_w(LGW_MBWSSF_ONLY_CRC_EN,0); /* default 1 */
